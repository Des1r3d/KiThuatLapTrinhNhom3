...
class Dashboard(QWidget):
    ...
    def setup_ui(self):
        ...
        self.expiring_card = StatCard(
            "Expiring Soon (30d)", 0, "⚠️",
            "Action needed", "expiring", self.theme
        )
        self.expired_card = StatCard(
            "Expired Medicines", 0, "❌",
            "Remove immediately", "expired", self.theme
        )
        self.low_stock_card = StatCard(
            "Low Stock Items", 0, "🛒",
            "Under threshold (5 units)", "low_stock", self.theme
        )
        ...
        pie_title = QLabel("🔵 Expiry Status Distribution")
        ...
        bar_title = QLabel("📊 Top 10 Medicines by Stock")
        ...
        expiry_title = QLabel("🟡 Approaching Expiry")
        ...
        stock_title = QLabel("🔴 Low Stock Items")
    ...
    def update_pie_chart(self):
        ...
        labels = ['Normal', 'Expiring', 'Expired']
        colors = [
            Theme.CHART_GREEN,
            Theme.CHART_ORANGE,
            Theme.CHART_RED
