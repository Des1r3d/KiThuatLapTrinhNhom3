# Form implementation generated from reading ui file 'C:\Users\Desired\Desktop\ki2nam2\kithuatlaptrinh\DoAnKiThuatLaptrinh\KiThuatLapTrinhNhom3\Ui Qt\sua_thanh_cong_dark.ui'
#
...
class Ui_dlg_edit_success(object):
    def setupUi(self, dlg_edit_success):
        dlg_edit_success.setObjectName("dlg_edit_success")
        dlg_edit_success.resize(400, 420)
        dlg_edit_success.setMinimumSize(QtCore.QSize(400, 420))
        dlg_edit_success.setMaximumSize(QtCore.QSize(400, 420))
        dlg_edit_success.setStyleSheet("QDialog { background-color: rgb(39, 57, 71); }")
        self.main_layout = QtWidgets.QVBoxLayout(dlg_edit_success)
        self.main_layout.setContentsMargins(10, 10, 10, 10)
        self.main_layout.setSpacing(0)
        self.main_layout.setObjectName("main_layout")
        self.container_frame = QtWidgets.QFrame(parent=dlg_edit_success)
...
"           ")
        ...
        self.lbl_desc.setStyleSheet("color: #E4E7EB; font-size: 14px;")
        ...
        self.retranslateUi(dlg_edit_success)
        QtCore.QMetaObject.connectSlotsByName(dlg_edit_success)

    def retranslateUi(self, dlg_edit_success):
        _translate = QtCore.QCoreApplication.translate
        self.lbl_icon.setText(_translate("dlg_edit_success", "✔"))
        self.lbl_title.setText(_translate("dlg_edit_success", "SỬA THUỐC THÀNH CÔNG"))
        self.lbl_desc.setText(_translate("dlg_edit_success", "Thông tin thuốc \'Paracetamol 500mg\' đã được cập nhật"))
        self.lbl_code.setText(_translate("dlg_edit_success", "Mã thuốc: K-A1.001"))
        self.btn_close.setText(_translate("dlg_edit_success", "Đóng thông báo"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    dlg_edit_success = QtWidgets.QDialog()
    ui = Ui_dlg_edit_success()
    ui.setupUi(dlg_edit_success)
    dlg_edit_success.show()
    sys.exit(app.exec())
