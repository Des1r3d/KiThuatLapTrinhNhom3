...
Thiết kế dựa trên kích thước cửa sổ chuẩn **1280x720** (theo cấu trúc code `app.py`) và chia làm 3 khu vực chức năng cố định:
...
* **Status Bar (Dưới cùng):** Chiều cao ~32px, hiển thị tổng số lượng thuốc và các thông báo/cảnh báo nhanh.
